...
class Utils
{
    ...
    public static function build_order_no(){
        return date('YmdHis').substr(implode(NULL, array_map('ord', str_split(substr(uniqid(), 7, 13), 1))), 0, 8).mt_rand(100, 999);
    }
    
    public static function build_orderNo16(){
        return mt_rand(1000, 9999).substr(implode(NULL, array_map('ord', str_split(substr(uniqid(), 7, 13), 1))), 0, 8).substr(microtime(), 2, 4);
    }
    
    public static function build_orderNo11(){
        return substr(implode(NULL, array_map('ord', str_split(substr(uniqid(), 7, 13), 1))), 0, 7).substr(microtime(), 2, 4);
    }
    public static function build_uniqid(){
     ...
     * @return string
     +----------------------------------------------------------
     */
    public static function build_verify ($length=4,$mode=1) {
